...
// 작동이 되긴함! 근데 마우스 뗐을 때 원래대로 안돌아가서, 여러번 마우스 올리면 결국 li 전체가 다 나와버리게 됨
...
// values.forEach((i, index) => {
//   i.addEventListener("mouseover", function () {
//     text[index].classList.add("look");

//     gsap
//       .timeline()
//       .to(text[index], { display: "block" }, 0)
//       .to(text[index], { opacity: 1, rotateX: "360deg" }, 0.3);
